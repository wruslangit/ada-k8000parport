...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_ck8000" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8d881d9f#;
   pragma Export (C, u00001, "main_ada_ck8000B");
   ...
   u00010 : constant Version_32 := 16#0336e7b2#;
   ...
   u00013 : constant Version_32 := 16#9762c9f2#;
   pragma Export (C, u00013, "ada__exceptionsB");
   u00014 : constant Version_32 := 16#585ef86b#;
   ...
   u00052 : constant Version_32 := 16#d68fb8f1#;
   ...
   u00065 : constant Version_32 := 16#0cdaa54a#;
   pragma Export (C, u00065, "system__mmap__os_interfaceB");
   u00066 : constant Version_32 := 16#82f29877#;
   pragma Export (C, u00066, "system__mmap__os_interfaceS");
   u00067 : constant Version_32 := 16#834dfe5e#;
   pragma Export (C, u00067, "system__mmap__unixS");
   u00068 : constant Version_32 := 16#fa90b46b#;
   pragma Export (C, u00068, "system__os_libB");
   u00069 : constant Version_32 := 16#4542b55d#;
   ...
   u00137 : constant Version_32 := 16#894fb81a#;
   pragma Export (C, u00137, "pkg_ada_dtstampB");
   u00138 : constant Version_32 := 16#25638e1e#;
   pragma Export (C, u00138, "pkg_ada_dtstampS");
   u00139 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00139, "ada__calendarB");
   u00140 : constant Version_32 := 16#c4f07049#;
   ...
   u00143 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00143, "ada__calendar__formattingB");
   u00144 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00144, "ada__calendar__formattingS");
   u00145 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00145, "ada__calendar__time_zonesB");
   u00146 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00146, "ada__calendar__time_zonesS");
   ...
   u00157 : constant Version_32 := 16#a6c9af38#;
   pragma Export (C, u00157, "system__float_controlS");
   u00158 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00158, "system__powten_tableS");
   u00159 : constant Version_32 := 16#4fc9bc76#;
   pragma Export (C, u00159, "ada__command_lineB");
   u00160 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00160, "ada__command_lineS");
   u00161 : constant Version_32 := 16#eb4fc41d#;
   pragma Export (C, u00161, "ada__real_timeB");
   u00162 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00162, "ada__real_timeS");
   u00163 : constant Version_32 := 16#c05c480c#;
   pragma Export (C, u00163, "system__taskingB");
   u00164 : constant Version_32 := 16#d15fc24c#;
   pragma Export (C, u00164, "system__taskingS");
   u00165 : constant Version_32 := 16#c333d44f#;
   pragma Export (C, u00165, "system__task_primitivesS");
   u00166 : constant Version_32 := 16#02d5b781#;
   pragma Export (C, u00166, "system__os_interfaceB");
   u00167 : constant Version_32 := 16#8b11eeee#;
   pragma Export (C, u00167, "system__os_interfaceS");
   u00168 : constant Version_32 := 16#ff1f7771#;
   pragma Export (C, u00168, "system__linuxS");
   u00169 : constant Version_32 := 16#198dbba9#;
   pragma Export (C, u00169, "system__os_constantsS");
   u00170 : constant Version_32 := 16#3d3b214a#;
   pragma Export (C, u00170, "system__task_primitives__operationsB");
   u00171 : constant Version_32 := 16#69ee9f34#;
   pragma Export (C, u00171, "system__task_primitives__operationsS");
   u00172 : constant Version_32 := 16#71c5de81#;
   pragma Export (C, u00172, "system__interrupt_managementB");
   u00173 : constant Version_32 := 16#24a21b5f#;
   pragma Export (C, u00173, "system__interrupt_managementS");
   u00174 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00174, "system__multiprocessorsB");
   u00175 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00175, "system__multiprocessorsS");
   u00176 : constant Version_32 := 16#375a3ef7#;
   pragma Export (C, u00176, "system__task_infoB");
   u00177 : constant Version_32 := 16#1c069690#;
   pragma Export (C, u00177, "system__task_infoS");
   u00178 : constant Version_32 := 16#f2eb7df6#;
   pragma Export (C, u00178, "system__tasking__debugB");
   u00179 : constant Version_32 := 16#aea59d30#;
   ...
   u00185 : constant Version_32 := 16#2779eac4#;
   ...
   u00196 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00196, "ada__strings__fixedB");
   u00197 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00197, "ada__strings__fixedS");
   u00198 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00198, "ada__strings__unbounded__text_ioB");
   u00199 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00199, "ada__strings__unbounded__text_ioS");
   u00200 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00200, "system__img_lldB");
   u00201 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00201, "system__img_lldS");
   u00202 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00202, "system__img_decB");
   u00203 : constant Version_32 := 16#e818e5df#;
