...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_k8000" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2c66c77c#;
   pragma Export (C, u00001, "main_ada_k8000B");
   ...
   u00136 : constant Version_32 := 16#2ac31c89#;
   pragma Export (C, u00136, "interfaces__c__extensionsS");
   u00137 : constant Version_32 := 16#58d813ea#;
   pragma Export (C, u00137, "pkg_aada_k8000B");
   u00138 : constant Version_32 := 16#10607d2d#;
   pragma Export (C, u00138, "pkg_aada_k8000S");
   ...
   u00141 : constant Version_32 := 16#2fae4b2f#;
   pragma Export (C, u00141, "pkg_ada_k8000S");
   u00142 : constant Version_32 := 16#894fb81a#;
   pragma Export (C, u00142, "pkg_ada_dtstampB");
   u00143 : constant Version_32 := 16#25638e1e#;
   pragma Export (C, u00143, "pkg_ada_dtstampS");
   ...
   u00148 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00148, "ada__calendar__formattingB");
   u00149 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00149, "ada__calendar__formattingS");
   u00150 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00150, "ada__calendar__time_zonesB");
   u00151 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00151, "ada__calendar__time_zonesS");
   u00152 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00152, "system__val_intB");
   u00153 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00153, "system__val_intS");
   u00154 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00154, "system__val_unsB");
   u00155 : constant Version_32 := 16#621b7dbc#;
   pragma Export (C, u00155, "system__val_unsS");
   u00156 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00156, "system__val_realB");
   u00157 : constant Version_32 := 16#b81c9b15#;
   pragma Export (C, u00157, "system__val_realS");
   u00158 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00158, "system__exn_llfB");
   u00159 : constant Version_32 := 16#fa4b57d8#;
   ...
   u00164 : constant Version_32 := 16#4fc9bc76#;
   pragma Export (C, u00164, "ada__command_lineB");
   u00165 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00165, "ada__command_lineS");
   u00166 : constant Version_32 := 16#eb4fc41d#;
   pragma Export (C, u00166, "ada__real_timeB");
   u00167 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00167, "ada__real_timeS");
   u00168 : constant Version_32 := 16#c05c480c#;
   pragma Export (C, u00168, "system__taskingB");
   u00169 : constant Version_32 := 16#d15fc24c#;
   pragma Export (C, u00169, "system__taskingS");
   u00170 : constant Version_32 := 16#c333d44f#;
   pragma Export (C, u00170, "system__task_primitivesS");
   u00171 : constant Version_32 := 16#02d5b781#;
   pragma Export (C, u00171, "system__os_interfaceB");
   u00172 : constant Version_32 := 16#8b11eeee#;
   pragma Export (C, u00172, "system__os_interfaceS");
   u00173 : constant Version_32 := 16#ff1f7771#;
   pragma Export (C, u00173, "system__linuxS");
   u00174 : constant Version_32 := 16#198dbba9#;
   pragma Export (C, u00174, "system__os_constantsS");
   u00175 : constant Version_32 := 16#3d3b214a#;
   pragma Export (C, u00175, "system__task_primitives__operationsB");
   u00176 : constant Version_32 := 16#69ee9f34#;
   pragma Export (C, u00176, "system__task_primitives__operationsS");
   u00177 : constant Version_32 := 16#71c5de81#;
   pragma Export (C, u00177, "system__interrupt_managementB");
   u00178 : constant Version_32 := 16#24a21b5f#;
   pragma Export (C, u00178, "system__interrupt_managementS");
   u00179 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00179, "system__multiprocessorsB");
   u00180 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00180, "system__multiprocessorsS");
   u00181 : constant Version_32 := 16#375a3ef7#;
   pragma Export (C, u00181, "system__task_infoB");
   u00182 : constant Version_32 := 16#1c069690#;
   pragma Export (C, u00182, "system__task_infoS");
   u00183 : constant Version_32 := 16#f2eb7df6#;
   pragma Export (C, u00183, "system__tasking__debugB");
   u00184 : constant Version_32 := 16#aea59d30#;
   ...
   u00187 : constant Version_32 := 16#273384e4#;
   pragma Export (C, u00187, "system__img_enum_newB");
   u00188 : constant Version_32 := 16#2779eac4#;
   ...
   u00190 : constant Version_32 := 16#577ab9d5#;
   pragma Export (C, u00190, "system__img_lliS");
   u00191 : constant Version_32 := 16#6ec3c867#;
   ...
   u00195 : constant Version_32 := 16#fe1ffede#;
   pragma Export (C, u00195, "ada__strings__boundedB");
   u00196 : constant Version_32 := 16#89c18940#;
   pragma Export (C, u00196, "ada__strings__boundedS");
   ...
   u00199 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00199, "ada__strings__fixedB");
   u00200 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00200, "ada__strings__fixedS");
   u00201 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00201, "ada__strings__unbounded__text_ioB");
   u00202 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00202, "ada__strings__unbounded__text_ioS");
   u00203 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00203, "system__img_lldB");
   u00204 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00204, "system__img_lldS");
   u00205 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00205, "system__img_decB");
   u00206 : constant Version_32 := 16#e818e5df#;
   pragma Export (C, u00206, "system__img_decS");
   u00207 : constant Version_32 := 16#2323a8af#;
   pragma Export (C, u00207, "system__memoryB");
   u00208 : constant Version_32 := 16#1f488a30#;
